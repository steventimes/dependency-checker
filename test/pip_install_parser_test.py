...
class TestPipInstallParserSmokeAndUnit(unittest.TestCase):
...
"""
    ...
    def test_ignores_editable_vcs_and_urls(self):
        content = "pip install -e . git+https://example/repo.git requests[socks]==2.28.0 https://example/x.whl\n"
